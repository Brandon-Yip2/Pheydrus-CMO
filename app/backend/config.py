...
CONFIG_ASK_APPROACH_PUBLIC = "ask_approach_public"
CONFIG_CHAT_APPROACH_PUBLIC = "chat_approach_public"
CONFIG_SEARCH_CLIENT_INTERNAL = "search_client_internal"
CONFIG_SEARCH_CLIENT_PUBLIC = "search_client_public"
