...
CONFIG_SEARCH_CLIENTS = "search_clients"  # Dict of index_key -> SearchClient for multi-index support
CONFIG_CHAT_APPROACHES = "chat_approaches"  # Dict of index_key -> ChatReadRetrieveReadApproach
CONFIG_INDEX_CONFIG = "index_config"  # Loaded index configuration from index_config.json
