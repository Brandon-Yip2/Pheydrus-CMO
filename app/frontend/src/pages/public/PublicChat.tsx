...
import { publicChatApi, publicConfigApi, RetrievalMode, ChatAppResponse, ChatAppResponseOrError, ChatAppRequest, ResponseMessage, SpeechConfig } from "../../api";
...
export function Component(): JSX.Element {
    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            const response = await publicChatApi(request, shouldStream);
            if (!response.body) {
    ...
    return (
        <div className={styles.container}>
            <Helmet>
                <title>{t("publicChat.pageTitle")}</title>
            </Helmet>
            <div className={styles.commandsSplitContainer}>
                <div className={styles.commandsContainer}>
                    <span className={styles.publicBadge}>{t("publicChat.badge")}</span>
                </div>
                <div className={styles.commandsContainer}>
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>{t("publicChat.emptyStateTitle")}</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>{t("publicChat.emptyStateSubtitle")}</h2>
